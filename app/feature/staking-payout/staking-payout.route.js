...
router.put(
	'/staking-platforms/:staking_platform_id/payouts/:id',
	authenticate,
...
/**
 * @swagger
 * /web/staking-platforms/{staking_platform_id}/payouts/{id}:
 *   put:
 *     summary: update staking payout
 *     tags:
 *       - Staking Payout
 *     description:
 *     parameters:
 ...
 *         in: body
 *         require: true
 *         description: provide max_payout to update
 *         schema:
 *              type: object
 *              required:
 *              - max_payout
